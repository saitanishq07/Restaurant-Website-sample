              ...
              >
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute bottom-0 left-0 right-0 h-[2px] bg-ember-gold"
          ...
          <AnimatePresence mode="popLayout">
            {filteredDishes.map((dish) => (
              <motion.div
                ...
                className="group cursor-pointer bg-ember-dark border border-ember-gold/15 hover:border-ember-gold/50 transition-all duration-500 overflow-hidden flex flex-col justify-between"
              >
                {/* Image Container */}
