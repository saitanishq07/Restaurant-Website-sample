...
export default function LightboxModal({ images, currentIndex, onClose, onPrev, onNext }) {
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-ember-black/95 backdrop-blur-2xl p-4 sm:p-8 select-none">
        ...
        <motion.div
          ...
          className="relative max-w-5xl max-h-[85vh] flex flex-col items-center justify-center text-center space-y-4"
        >
