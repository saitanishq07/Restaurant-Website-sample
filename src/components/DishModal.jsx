...
export default function DishModal({ dish, onClose, onAddToReservationNotes, isAddedToNotes }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      {/* Modal Window */}
      <div className="relative z-10 w-full max-w-4xl bg-ember-dark border border-ember-gold/30 shadow-2xl overflow-hidden my-auto transition-all duration-300 transform scale-100">
        {/* Close Button */}
        <button
          onClick={onClose}
