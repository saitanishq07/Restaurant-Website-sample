...
import { CheckCircle2, X, Calendar, Clock, Users, Flame, Mail, Phone } from 'lucide-react';
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative z-10 w-full max-w-xl bg-ember-dark border border-ember-gold/40 p-8 sm:p-10 shadow-2xl overflow-hidden my-auto text-center space-y-6"
        >
